...
export default function Home() {
  return (
    <main className="flex flex-col mx-auto ">
      <div className="flex justify-center w-[80%] mx-auto items-center">
        <div className="">
          ...
          <div className="flex gap-x-4  mt-6">
            <button className="bg-primer w-52">Ask me</button>
            <button className="bg-sekunder w-52">Buy now</button>
          </div>
        </div>
